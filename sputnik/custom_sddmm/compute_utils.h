...
#ifndef THIRD_PARTY_SPUTNIK_CUSTOM_SDDMM_COMPUTE_UTILS_H_
#define THIRD_PARTY_SPUTNIK_CUSTOM_SDDMM_COMPUTE_UTILS_H_
...
#endif  // THIRD_PARTY_SPUTNIK_CUSTOM_SDDMM_COMPUTE_UTILS_H_
