...
#ifndef THIRD_PARTY_SPUTNIK_CUSTOM_SDDMM_DENSE_TO_SHARED_H_
#define THIRD_PARTY_SPUTNIK_CUSTOM_SDDMM_DENSE_TO_SHARED_H_
...
#endif  // THIRD_PARTY_SPUTNIK_CUSTOM_SDDMM_DENSE_TO_SHARED_H_
