...
#ifndef THIRD_PARTY_SPUTNIK_CUSTOM_SDDMM_ALL_REDUCE_H_
#define THIRD_PARTY_SPUTNIK_CUSTOM_SDDMM_ALL_REDUCE_H_

/**
 * @file @brief Defines a functor for performing a batch of all reduces
 * to calculate the final results of the CUSTOM_SDDMM.
 */
...
#endif  // THIRD_PARTY_SPUTNIK_CUSTOM_SDDMM_ALL_REDUCE_H_
