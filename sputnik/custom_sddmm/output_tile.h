...
#ifndef THIRD_PARTY_SPUTNIK_CUSTOM_SDDMM_OUTPUT_TILE_H_
#define THIRD_PARTY_SPUTNIK_CUSTOM_SDDMM_OUTPUT_TILE_H_
...
#endif  // THIRD_PARTY_SPUTNIK_CUSTOM_SDDMM_OUTPUT_TILE_H_
