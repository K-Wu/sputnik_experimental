...
#ifndef THIRD_PARTY_SPUTNIK_CUSTOM_SPMM_PREDICATE_UTILS_H_
#define THIRD_PARTY_SPUTNIK_CUSTOM_SPMM_PREDICATE_UTILS_H_
...
/**
 * @brief Setter for k-dimension load predicates on the final custom_spmm
 * main-loop iteration.
 */
...
#endif  // THIRD_PARTY_SPUTNIK_CUSTOM_SPMM_PREDICATE_UTILS_H_
