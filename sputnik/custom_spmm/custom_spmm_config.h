...
#ifndef THIRD_PARTY_SPUTNIK_CUSTOM_SPMM_CUSTOM_SPMM_CONFIG_H_
#define THIRD_PARTY_SPUTNIK_CUSTOM_SPMM_CUSTOM_SPMM_CONFIG_H_
...
#endif  // THIRD_PARTY_SPUTNIK_CUSTOM_SPMM_CUSTOM_SPMM_CONFIG_H_
