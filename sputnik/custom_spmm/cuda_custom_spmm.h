...
#ifndef THIRD_PARTY_SPUTNIK_CUSTOM_SPMM_CUDA_CUSTOM_SPMM_H_
#define THIRD_PARTY_SPUTNIK_CUSTOM_SPMM_CUDA_CUSTOM_SPMM_H_
 ...
 */
cudaError_t CudaCustomSpmmBiasRelu(int m, int k, int n, int nonzeros,
                             const int* __restrict__ row_indices,
                             const float* __restrict__ values,
                             const int* __restrict__ row_offsets,
                             const int* __restrict__ column_indices,
...
#endif  // THIRD_PARTY_SPUTNIK_CUSTOM_SPMM_CUDA_CUSTOM_SPMM_H_
